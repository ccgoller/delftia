...
```{=html}
<section class="hero-section" aria-labelledby="about-hero-heading" style="padding:3.5rem 2rem 3rem;">
  <h1 id="about-hero-heading" style="font-size:clamp(1.8rem,4vw,2.6rem);">About The Delftia Project</h1>
