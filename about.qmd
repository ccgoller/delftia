...
```{=html}
<section class="hero-section" style="padding:3.5rem 2rem 3rem;" aria-labelledby="about-heading">
  <h1 id="about-heading" style="font-size:clamp(1.8rem,4vw,2.6rem);">About The Delftia Project</h1>
...
<div class="team-grid">
  <div class="team-card">
    <div class="team-avatar" aria-hidden="true">CG</div>
    <h3>Dr. Carlos Goller</h3>
    <div class="team-role">Principal Investigator · NC State</div>
  </div>
  <div class="team-card">
    <div class="team-avatar" aria-hidden="true">LR</div>
    <h3>Lauren Ramilo</h3>
    <div class="team-role">Undergraduate Researcher</div>
  </div>
  <div class="team-card">
    <div class="team-avatar" aria-hidden="true">DN</div>
    <h3>Daiza Norman</h3>
    <div class="team-role">BIT Research Assistant</div>
  </div>
  <div class="team-card">
    <div class="team-avatar" aria-hidden="true">RT</div>
    <h3>Rabeya Tahir</h3>
...
For more information, visit [NC State University's website](https://www.ncsu.edu) or check out the [News](news.html) section for recent updates and opportunities.
:::
